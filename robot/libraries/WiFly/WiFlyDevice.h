...
class WiFlyDevice {
  public:
    ...
    boolean joinAdHocNetwork(const char *ssid, char *ipAddr, char *netMask);
    ...
    void SetNetwork(char *ipAddr, char *netMask);

    void EnableUDPAndTCP();

    void SetBroadcastInterval(byte  interval);
